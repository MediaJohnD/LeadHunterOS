...
ALLOW_CACHE_RESCUE: bool = _bool("ALLOW_CACHE_RESCUE", False)
INSECURE_TLS_FALLBACK: bool = _bool("INSECURE_TLS_FALLBACK", False)
ENABLE_PAID_FALLBACKS: bool = _bool("ENABLE_PAID_FALLBACKS", False)

# -- DAILY HOT LEADS OPERATIONS ------------------------------------------------
DAILY_HOT_TARGET: int = _int("DAILY_HOT_TARGET", 10)
DAILY_WARM_TARGET: int = _int("DAILY_WARM_TARGET", 100)
HOT_MIN_ICP_SCORE: int = _int("HOT_MIN_ICP_SCORE", 80)
HOT_MIN_EVIDENCE_SCORE: int = _int("HOT_MIN_EVIDENCE_SCORE", 60)
HOT_MIN_SIGNAL_COUNT: int = _int("HOT_MIN_SIGNAL_COUNT", 20)
WARM_MIN_ICP_SCORE: int = _int("WARM_MIN_ICP_SCORE", 70)
WARM_MIN_EVIDENCE_SCORE: int = _int("WARM_MIN_EVIDENCE_SCORE", 45)
WARM_MIN_SIGNAL_COUNT: int = _int("WARM_MIN_SIGNAL_COUNT", 8)
MORNING_DIGEST_HOUR_LOCAL: int = _int("MORNING_DIGEST_HOUR_LOCAL", 6)
MORNING_DIGEST_MINUTE_LOCAL: int = _int("MORNING_DIGEST_MINUTE_LOCAL", 30)
...
# -- PHASE 2 HARDENING ---------------------------------------------------------
DETERMINISTIC_ORCHESTRATION_DEFAULT: bool = _bool("DETERMINISTIC_ORCHESTRATION_DEFAULT", True)
PARSER_ERROR_RETRY_LIMIT: int = _int("PARSER_ERROR_RETRY_LIMIT", 2)
RUN_FAIL_MIN_SAVED_LEADS: int = _int("RUN_FAIL_MIN_SAVED_LEADS", 3)
RUN_FAIL_MIN_SIGNAL_COUNT: int = _int("RUN_FAIL_MIN_SIGNAL_COUNT", 8)
RUN_FAIL_MIN_DISTINCT_SOURCE_FAMILIES: int = _int("RUN_FAIL_MIN_DISTINCT_SOURCE_FAMILIES", 2)
SLACK_WEBHOOK_URL: str = os.getenv("SLACK_WEBHOOK_URL", "")
DAILY_ALERT_EMAIL_TO: str = os.getenv("DAILY_ALERT_EMAIL_TO", "")
