...
class PerplexityAdapter(LLMProviderAdapter):
    name = "perplexity"
    endpoint = "https://api.perplexity.ai/chat/completions"

    def is_configured(self) -> bool:
        key = (config.PERPLEXITY_API_KEY or "").strip()
    ...
    def capabilities(self) -> LLMCapability:
        return LLMCapability(supports_tools=False, supports_streaming=False, supports_system_role=True)
